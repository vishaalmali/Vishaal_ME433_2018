package com.example.qunyu.androidusb;
...
//    static long prevtime = 0; // for FPS calculation
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myTextView3 = (TextView) findViewById(R.id.textView05);
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
            ...
            myControl0 = (SeekBar) findViewById(R.id.seek0);
            myControl = (SeekBar) findViewById(R.id.seek1);
...
//                myTextView2.setText("value on click is "+myControl.getProgress());
    ...
    public void onSurfaceTextureUpdated(SurfaceTexture surface) {
        ...
        myControl0.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
